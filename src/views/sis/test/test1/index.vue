    ...
    setup() {
      ...
      async function getHistoryData() {
        ...
        setOptions({
          ...
          legend: {
            data: ['#1机组高背压排汽温度', '#1机组低背压排汽温度', '#1机组高背压', '#1机组低背压'],
            textStyle: {
              fontSize: 18,
            },
          },
          ...
          series: [
            {
              ...
              type: 'line',
              symbol: 'none',
              data: data.chartValue['GBYPQWD_1'],
              lineStyle: {
                color: 'rgb(0, 128, 0)',
              },
              itemStyle: {
            ...
            },
            {
              ...
              type: 'line',
              symbol: 'none',
              data: data.chartValue['DBYPQWD_1'],
              lineStyle: {
                color: 'rgb(128, 128, 0)',
              },
              itemStyle: {
          ...
          markLine: {
            symbol: ['none', 'none'], // 不显示标记点
            data: [
              {
                xAxis: '2025-05-04 20:56:00', // 试验开始时间
                label: {
                  formatter: '试验开始时间',
                  position: 'insideTop',
                },

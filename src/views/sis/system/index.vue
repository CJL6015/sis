<template>
  <PageWrapper title="冷端系统特性查询">
        ...
        <a-row :gutter="24" class="custom-row-gap">
          <a-col :md="4">
            <a-form-item label="机组">
              <a-select v-model:value="formData.unit" disabled>
    ...
    <a-card>
      <a-form :model="formData1" :label-col="labelCol">
        <a-row :gutter="24" class="custom-row-gap">
          <a-col :md="4">
            <a-form-item label="机组">
              <a-select v-model:value="formData1.unit" disabled>
                <a-select-option value="1">#1机组 </a-select-option>
                <a-select-option value="2">#2机组 </a-select-option>
              </a-select>
            </a-form-item></a-col
          ...
          <a-col :md="8">
            <a-form-item label="历史时间">
              <a-form-item name="input-number" no-style>
                <a-range-picker v-model:value="historyTime1" show-time />
              </a-form-item> </a-form-item
          ></a-col>
          <a-col :md="1">
            <a-form-item>
              <a-button type="primary" html-type="submit" @click="getScatterData1">确定</a-button>
            </a-form-item>
          </a-col>
        </a-row>
      </a-form>
  ...
  export default {
    ...
    setup() {
      ...
      async function getOptions() {
        ...
        formData1.value.x = data[0];
        formData1.value.y = data[1];
        getScatterData();
        getScatterData1();
      }
      ...
      async function getScatterData1() {
        const [startDate, endDate] = historyTime.value;
        const startDateDate = startDate.toDate();
        const endDateDate = endDate.toDate();
        const params = {
